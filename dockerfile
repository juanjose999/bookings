...
# Copia los archivos de tu proyecto relacionados con la construcción al directorio de trabajo
...
# Copia los recursos necesarios para la aplicación (como el archivo de propiedades)
